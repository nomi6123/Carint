...
const Footer = () => {
  return (
    <div className="bg-[#04233B] pb-2">
      <div className="bg-[#04233B] p-10 md:p-[40px] py-10 w-full mx-auto max-w-[1300px] flex max-xl:flex-wrap justify-center items-center gap-8 text-white">
        {/* Address Section */}
