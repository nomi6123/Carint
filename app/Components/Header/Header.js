...
const Header = () => {
  ...
  return (
    <div className="w-full bg-white shadow-sm shadow-gray-600 text-black sticky top-0 z-50">
      {/* Main Header Container */}
      <div className="max-w-[1300px] mx-auto p-4 lg:p-6 flex justify-between items-center px-2 lg:px-3">
        {/* Logo */}
        <a href="#home">
          <h2 className="text-black font-bold text-2xl transition-colors hover:text-[#31C2E8]">
            Carint
          </h2>
        </a>
          ...
          className={`${
           ...
           justify-center items-center absolute
            lg:static top-[68px] left-0 w-full lg:w-auto
             bg-[#0e75a5] lg:bg-transparent z-40 lg:z-auto lg:gap-3`}
        >
          {/* Links */}
          {[
          ...
          <div className="flex gap-4 mt-4 lg:mt-0 px-4 lg:px-0 justify-center items-center">
            <div className="flex justify-center items-center gap-1">
              <IoIosPerson
                className="text-[20px] cursor-pointer hover:text-[#31C2E8] transition-colors"
                onClick={toggleLoginPopup}
              />
              <h2
                className="text-[19px] hover:text-[#31C2E8] cursor-pointer transition-colors"
                onClick={toggleLoginPopup}
              >
                LOGIN
              </h2>
